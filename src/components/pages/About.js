      ...
      <section className="info">
        <div className="quote">
          <p>
            ...
            am a <span className="primary-color">Web Developer</span>. I
            specialize in Front-End Web Development but have worked with the
            Back-End as well. I enjoy solving problems through code, and I am
            excited to work alongside other amazing programmers.
          </p>
          <p>
